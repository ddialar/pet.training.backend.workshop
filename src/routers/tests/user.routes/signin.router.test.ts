...
describe(`Integration test - POST ${BASE_URL}`, () => {
  ...
  it.todo('returns CREATED (201) and the new user is persisted successfully')
  ...
  it.todo('returns BAD_REQUEST (400) when trying to record an already persisted user')
  ...
  it.todo('returns BAD_REQUEST (400) when email is not provided')
  ...
  it.todo('returns BAD_REQUEST (400) when email is malformed')
  ...
  it.todo('returns BAD_REQUEST (400) when password is not provided')
  ...
  it.todo('returns BAD_REQUEST (400) when password is too short')
  ...
  it.todo('returns BAD_REQUEST (400) when password contains non valid characters')
  ...
  it.todo('returns BAD_REQUEST (400) when firstName is not provided')
  ...
  it.todo('returns BAD_REQUEST (400) when firstName is an empty string')
  ...
  it.todo('returns BAD_REQUEST (400) when lastName is not provided')
  ...
  it.todo('returns BAD_REQUEST (400) when lastName is an empty string')
