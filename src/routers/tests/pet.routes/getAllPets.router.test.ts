...
describe(`Integration test - GET ${BASE_URL}`, () => {
  ...
  it.todo('returns OK (200) and the set of persisted pets')
  ...
  it.todo('returns OK (200) and an empty array when there are no persisted pets')
  ...
  it.todo('returns BAD_REQUEST (400) when there is an error retrieving the pets')
